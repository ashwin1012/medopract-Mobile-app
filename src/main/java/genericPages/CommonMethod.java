	...
	// Click on the webelement
		public void click(String locatorKey) throws Exception {
			try {
				...
				waitForElementVisibility(element, 50);
				waitForElementToBeClickable(element, 50);
				element.click();
		...
		// Clear the Data
			public void clearData(String locatorKey) throws Exception {
				...
				test.log(LogStatus.PASS, "Clear the data : " + locatorKey,"Clear the data " + locatorKey + " Successfully");
					...
					test.log(LogStatus.FAIL, "Clear the data : " + locatorKey,"Failed to clear the data " + locatorKey + e.getMessage()+ test.addScreenCapture(takeScreenShot(locatorKey)));
				}
