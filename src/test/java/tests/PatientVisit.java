...
public class PatientVisit extends CommonMethod{

public PatientVisit() throws Exception {
		super();
		// TODO Auto-generated constructor stub
	}

Logger log = LogManager.getLogger(PatientVisit.class.getName());
	...
	@Test(priority=1)
	public void patientVisit() throws Exception {
		test=reports.startTest("TC001 Patient Visit");
	}
